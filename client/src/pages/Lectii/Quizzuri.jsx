...
const Quizzuri = () => {
    ...
    const quizzuri = [...LECTII.capitole[0].lectii.map(e => { return { ...e, idCapitol: 0 } }), ...LECTII.capitole[1].lectii.map(e => { return { ...e, idCapitol: 1 } })].filter((e, i) => e.tip == 'quizz')
